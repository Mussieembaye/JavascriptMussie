while (!player1){
    var player1 = prompt('Speler één: Voer je naam in. Je zult rood zijn.');
};
var player1Color = 'red';

while (!player2){
    var player2 = prompt('Speler twee: Voer je naam in. Je zult geel zijn.');
};
...
var currentPlayer = 1;
let winner;
playerTurn.textContent = `${player1} aan de buurt!`
        ...
        if (tableRow[i].children[column].style.backgroundColor == 'white'){
            ...
            if (currentPlayer === 1){
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    playerTurn.textContent = `${player1} Gewonen!!`;
                    playerTurn.style.color = player1Color;
                    return alert(`${player1} Gewonen!!`);
                }else if (drawCheck()){
                    playerTurn.textContent = 'Gelijk speel!';
                    return alert('Gelijk speel!');
                }else{
                    playerTurn.textContent = `${player2} aan de buurt`
                    return currentPlayer = 2;
                }
            }else{
                row[0].style.backgroundColor = 'yellow';
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    playerTurn.textContent = `${player2} Gewonen!!`;
                    playerTurn.style.color = player2Color;
                    return alert(`${player2} Gewonen!!`);
                }else if (drawCheck()){
                    playerTurn.textContent = 'Gelijk speel!';
                    return alert('Gelijk speel!');
                }else{
...
resetBtn.addEventListener('click', () => {
    ...
    return (currentPlayer === 1 ? playerTurn.textContent = `${player1}aan de buurt` : playerTurn.textContent = `${player2}'s turn`);
});